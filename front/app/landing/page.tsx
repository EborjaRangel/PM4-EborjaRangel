...
import CategoryPromoMarquee from "@/components/landing/CategoryPromoMarquee";
...
function LandingPage() {
  return (
    <PageShell shellTight>
      <section
        className={`${PULSE.cardTight} mb-2 px-3 py-2 transition hover:border-[#1DA1F2]/25 hover:shadow-[0_8px_32px_rgba(29,161,242,0.12)] sm:px-4 sm:py-2.5`}
        aria-label="Categorías"
      >
        <CategoryPromoMarquee />
      </section>
        ...
        <div className="relative flex flex-col gap-5 sm:gap-6 lg:flex-row lg:items-start lg:gap-8">
            ...
            <div className="relative w-full">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-[#1877F2]/25 bg-[#0a1628] shadow-[0_12px_40px_rgba(24,119,242,0.2)]">
                <HeroAutoplayVideo
                  ...
                  aria-label="Video de Dreams Time para PULSE"
                />
              </div>
            </div>
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-[#65676B] sm:text-lg">
              <span className="landing-dreams-time-marquee font-semibold">
                Dreams Time
              </span>{" "}
